 ...
 */
@property (nonatomic, strong, nullable) NSArray<__kindof NSObject <TSCTableSectionDataSource> *> *dataSource;
 ...
 */
- (void)setDataSource:(NSArray <TSCTableSection <TSCTableSectionDataSource> *> * _Nonnull)dataSource animated:(BOOL)animated;
 ...
 */
@property (nonatomic, strong) NSArray <TSCTableSection <TSCTableRowDataSource> *> * _Nullable flattenedDataSource;
 ...
 */
@property (nonatomic, strong) NSArray <id <TSCTableInputRowDataSource>> * _Nullable missingRequiredInputRows;
