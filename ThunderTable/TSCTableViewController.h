 ...
 */
@property (nonatomic, strong) NSArray <id <TSCTableSectionDataSource>> * _Nullable dataSource;
 ...
 */
- (void)setDataSource:(NSArray <id <TSCTableSectionDataSource>> * _Nonnull)dataSource animated:(BOOL)animated;
 ...
 */
@property (nonatomic, strong) NSArray <id <TSCTableRowDataSource>> * _Nullable flattenedDataSource;
